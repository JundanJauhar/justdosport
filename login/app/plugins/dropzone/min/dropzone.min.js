                    ...
                    return (
                      arguments.length > 1 &&
                        (y((t = arguments[1])) &&
                          ((n = t.body),
                          d(n) === S &&
                            ((r = t.headers ? new k(t.headers) : new k()).has('content-type') || r.set('content-type', 'application/x-www-form-urlencoded;charset=UTF-8'), (t = g(t, { body: m(0, String(n)), headers: m(0, r) })))),
                        i.push(t)),
                      E.apply(this, i)
                    );
                  },
                      ...
                      try {
                        for (u.s(); !(a = u.n()).done; ) {
                          ...
                          (s.upload.total && s.upload.bytesSent && s.upload.bytesSent == s.upload.total) ||
                            (n ? ((s.upload.progress = (100 * n.loaded) / n.total), (s.upload.total = n.total), (s.upload.bytesSent = n.loaded)) : ((s.upload.progress = 100), (s.upload.bytesSent = s.upload.total)),
