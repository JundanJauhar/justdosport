...
<body>
    <nav class="bg-none fixed w-full z-20 dark:border-gray-600" id='navbar'>
        <div class=" flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            ?>
                <span class="text-white mr-3 font-medium">Halo, <?php echo htmlspecialchars($_SESSION['nama']); ?></span>
                <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'owner'): ?>
                    <a href="../admin/index.php" class="mr-2">
                        <button type="button" 
                            class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none font-medium rounded-sm text-sm px-4 py-2 text-center">
                            Dashboard Owner
                        </button>
                    </a>
                <?php endif; ?>
                <a href="../login/logout.php">
                    <button type="button" 
                        class="text-gray-700 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none font-medium rounded-sm text-sm px-4 py-2 text-center ">
                        Keluar
                    </button>
                </a>
            <?php else: ?>
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul
                    ...
                    <?php if (isset($_SESSION['nama']) && isset($_SESSION['role']) && $_SESSION['role'] === 'customer'): ?>
                    <li>
                        <a href="../Pages/PesananSaya.php" class="block py-2 px-3 text-white hover:text-green-300 font-bold transition">Pesanan Saya</a>
                    </li>
                    <?php endif; ?>
                    <li>
